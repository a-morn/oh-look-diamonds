...
var p = createjs.extend(AttackBird, createjs.Sprite); // eslint-disable-line no-undef
...
p.setup = function(current) {
	...
	this.falconTimer = 0;
	this.target = 0;
	this.shape = new createjs.Shape(); // eslint-disable-line no-undef
...
AttackBird.prototype.clone = function() {
	var clone = new AttackBird(new createjs.SpriteSheet(SpriteSheetData.enemybirds), this.currentAnimation); // eslint-disable-line no-undef
...
AttackBird.prototype.setGrilled = function() {
	...
	this.state = 'grilled';
	var instance = createjs.Sound.play('grilled'); // eslint-disable-line no-undef
	instance.volume = 1;
};

createjs.promote(AttackBird, 'Sprite'); // eslint-disable-line no-undef
