export function createBitmap(queRes, options) {
...
export function createSprite(data, anim, options) {
...
export function createCircle(r,color,options) {
...
export function createRectangle(w,h,color,options) {
...
export function createText(msg, font, color, options) {
