export const spriteSheets: {
  // type createjs.SpriteSheet is outdated
  [key: string]: (createjs.SpriteSheet & any) | null // eslint-disable-line @typescript-eslint/no-explicit-any
} = {
  hobo: null,
  dHouse: null,
  cat: null,
...
export function setValues(queue: createjs.LoadQueue): void {
  spriteSheets.hobo = {
    framerate: 24,
  ...
  spriteSheets.wick = {
    ...
    animations: { cycle: [0, 35, 'still', 2], still: [0] },
  }

  spriteSheets.onlookers = {
    framerate: 5,
