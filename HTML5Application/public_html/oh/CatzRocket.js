var CatzRocket = (function(){
    ...
    catzRocket.update = function(grav,wind,event){  
        ...
        if(catzRocket.catzState !== catzRocket.catzStateEnum.SecondDownloop 
                ...
                && catzRocket.catzState !== catzRocket.catzStateEnum.OutOfFuelUpsideDown){
    ...
    function changeState(state){
        ...
        if(state===catzRocket.catzStateEnum.Normal
            ...
            || state===catzRocket.catzStateEnum.OutOfFuel
            || state===catzRocket.catzStateEnum.OutOfFuelUpsideDown){
    ...
    catzRocket.canCollide = function(){
        return (catzRocket.catzState!==catzRocket.catzStateEnum.FellOffRocket
                && !catzRocket.hasFrenzy());
    };
